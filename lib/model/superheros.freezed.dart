...
/// @nodoc
abstract class _$$_SuperherosCopyWith<$Res>
    implements $SuperherosCopyWith<$Res> {
  factory _$$_SuperherosCopyWith(
          _$_Superheros value, $Res Function(_$_Superheros) then) =
      __$$_SuperherosCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({String? name, String? power, String? url});
}
...
/// @nodoc
class __$$_SuperherosCopyWithImpl<$Res>
    extends _$SuperherosCopyWithImpl<$Res, _$_Superheros>
    implements _$$_SuperherosCopyWith<$Res> {
  __$$_SuperherosCopyWithImpl(
      _$_Superheros _value, $Res Function(_$_Superheros) _then)
      : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$_Superheros with DiagnosticableTreeMixin implements _Superheros {
  _$_Superheros({this.name, this.power, this.url});

  factory _$_Superheros.fromJson(Map<String, dynamic> json) =>
      _$$_SuperherosFromJson(json);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_SuperherosCopyWith<_$_Superheros> get copyWith =>
      __$$_SuperherosCopyWithImpl<_$_Superheros>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_SuperherosToJson(
      this,
    );
  }
}
...
abstract class _Superheros implements Superheros {
  factory _Superheros(
      {final String? name,
      final String? power,
      final String? url}) = _$_Superheros;

  factory _Superheros.fromJson(Map<String, dynamic> json) =
      _$_Superheros.fromJson;
